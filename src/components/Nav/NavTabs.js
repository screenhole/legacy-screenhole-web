...
const supIcon = (
  <svg width="34" height="34" xmlns="http://www.w3.org/2000/svg">
    <g fill="none" fillRule="evenodd">
      <path
        d="M7 1a6 6 0 0 0-6 6v12a6 6 0 0 0 6 6h1v7.4l8.338-7.4H27a6 6 0 0 0 6-6V7a6 6 0 0 0-6-6H7z"
        stroke="currentColor"
        strokeWidth="2"
      />
      <path
        d="M23.358 9.488l-1.8 8.508h1.884l.66-3.072h1.344c2.004-.012 3.36-1.14 3.36-3 0-1.452-1.092-2.436-2.64-2.436h-2.808zm2.328 1.632c.84 0 1.164.384 1.164.972s-.384 1.2-1.428 1.2h-.972l.468-2.172h.768zM19.725 9.488l-1.127 5.424c-.193.936-.72 1.392-1.465 1.392-.935 0-1.307-.504-1.307-1.212 0-.156.036-.432.096-.72l1.031-4.884h-1.92l-.995 4.788c-.084.42-.144.708-.144 1.092 0 1.68 1.224 2.808 3.072 2.808 1.655 0 3.035-.972 3.455-2.916l1.224-5.772h-1.92zM9.526 16.532c-1.044-.024-1.476-.72-1.476-1.428 0-.108.012-.216.024-.276l-1.74.3a1.869 1.869 0 0 0-.024.324c0 1.104.84 2.724 3.252 2.724 1.968 0 3.084-1.344 3.084-2.676 0-1.044-.528-1.836-1.848-2.4l-.9-.384c-.336-.144-.6-.372-.6-.804 0-.468.408-.948 1.104-.948 1.152 0 1.26.888 1.26 1.128l1.764-.288c0-.876-.6-2.484-2.94-2.484-1.644 0-3.096 1.08-3.096 2.76 0 1.02.528 1.872 1.68 2.34l.996.408c.48.204.612.48.612.816 0 .54-.42.888-1.152.888z"
        fill="currentColor"
        fillRule="nonzero"
      />
    </g>
